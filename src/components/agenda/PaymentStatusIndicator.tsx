...
function resolvePaymentState({
  ...
  price,
  bonoId,
}: Pick<PaymentStatusIndicatorProps, 'paymentStatus' | 'price' | 'bonoId'>): 'paid' | 'pending' | null {
...
export function PaymentStatusIndicator({
  ...
  const Icon = isPaid ? CheckCircle2 : CreditCard;
  const label = isPaid ? 'Pagado' : 'Pago pendiente';
