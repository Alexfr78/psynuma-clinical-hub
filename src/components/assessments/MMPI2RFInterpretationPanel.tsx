...
export function MMPI2RFInterpretationPanel({ 
  interpretation, 
  onRegenerate,
  isRegenerating 
}: MMPI2RFInterpretationPanelProps) {
        ...
        <CardContent className="space-y-3">
          ...
          {interpretation.validez?.escalasProblematicas?.length > 0 && (
            <div className="flex flex-wrap gap-2">
              <span className="text-sm text-muted-foreground">Escalas problemáticas:</span>
              {interpretation.validez.escalasProblematicas.map((escala, i) => (
          ...
          <CardContent className="space-y-3">
              ...
              <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-medium text-sm">Riesgo Suicida (SUI)</span>
            ...
            {interpretation.riesgos.violencia && (
              <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-medium text-sm">Riesgo de Violencia (AGG)</span>
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-medium">
                          ...
                          <span className="text-muted-foreground ml-2 font-normal">
                            {MMPI2RF_SCALE_LABELS[escala.escala]?.label || ''}
                          </span>
                        </span>
