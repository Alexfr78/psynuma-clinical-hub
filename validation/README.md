...
`invoice-export-2026-02-01-to-2026-07-25-v2.csv` es un archivo de prueba sintético generado por
`scripts/generate-invoice-export-validation.ts`.

Representa una exportación cuyo rango se aplica a `invoice_date`, desde el
1 de febrero hasta el 25 de julio de 2026, con canceladas incluidas y borradores
excluidos.
