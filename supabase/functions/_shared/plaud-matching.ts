 ...
 *
 * NOTA: esta es la copia canónica (Deno-compatible) de esta lógica. `src/lib/plaud-matching.ts`
 * re-exporta este mismo archivo para que el navegador y los 241 tests de vitest usen exactamente
 * las mismas reglas — no dupliques esta lógica, edita solo aquí.
 */

import type { ContiguityPair, OverlapPair, SegmentationResult } from './plaud-segmentation.ts';
